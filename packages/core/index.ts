import type { IOptions, SentryPlugin } from "@fe-sentry/types";

import { sentry } from "@fe-sentry/utils";

import { DEFAULT_OPTIONS } from "@fe-sentry/constants";
...
function init(
  ...
  if (dsn === "") {
    console.error("[fe-sentry] dsn is empty");
    return;
  }
  setup();
}
