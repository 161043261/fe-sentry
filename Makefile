...
init: ## Initial commit
	rm -rf ./.git
	git init
	git remote add origin git@github.com:161043261/fe-sentry.git
	git add -A
...
clean: ## Clean up
	...
	rm -rf ./packages/demo/dist
	rm -rf ./packages/performance/dist
	rm -rf ./packages/reporter/dist
	rm -rf ./packages/screen-record/dist
